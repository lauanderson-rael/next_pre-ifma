...
//                      ({title})
//                      <div className='px-4 py-0 bg-orange-500  rounded flex itens-center text-center justify-center text-white'>
//                         40:00
//                      </div>
//                </div>
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <header className="sticky top-0 z-50">
        ...
        <TopTitle title={`${type} - ${year}`}>
          <div className='flex gap-2'>
            ({title})
            {/* <div className='px-4 py-0 bg-orange-500 rounded flex items-center text-center justify-center text-white'>
              40:00
            </div> */}
          </div>
        </TopTitle>
