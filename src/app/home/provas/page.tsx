         ...
         <main className=" flex flex-col items-center gap-4  max-h-[calc(100dvh-160px)] overflow-y-auto">
            ...
            {mostrarResultados && (
               <section className="w-full max-w-3xl flex flex-col gap-6 px-4 mt-6 mb-20">
                  ...
                  <div className="flex justify-between items-center gap-8 bg-gray-300 p-4 rounded-lg shadow ">
                     <div>
                        <h3 className="text font-bold text-amber-900 mb-2 text-sm md:text-base">
                           PROCESSO SELETIVO UNIFICADO DE ALUNOS - IFMA {ano}
                        </h3>
                        <p className="text-sm font-semibold md:text-base">{ano} - Prova Forma {tipo}</p>
                     </div>
                     <a href="#" className="inline-block px-4 py-2 text-sm md:text-base bg-red-700 text-white rounded hover:bg-red-900">
                        PDF
                     </a>
                  </div>

                  <div className="flex justify-between items-center bg-gray-300 p-4 rounded-lg shadow ">
